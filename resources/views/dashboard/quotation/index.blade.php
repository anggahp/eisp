                ...
                <div class="col-md-12">
                    ...
                    <div class="pull-right ">
                        <div class="input-group input-group-sm input-daterange pull-right" style="width: 150px;">
                            <input type="text" id="strDate" name="strDate" value="{{date('m/Y')}}" class="form-control input-sm">
                            <div class="input-group-append">
                              <button class="btn btn-success" id="btnCari" type="button"><i class="fa fa-search"></i></button>
                            </div>
                        </div>
								...
								<table class="table table-hover table-responsive table-bordered mb-0 data-table">
                                    <thead>
										<tr>
											...
											<th class="txtCenter" width="350"> Supplier 1</th>
											<th class="txtCenter" width="350"> Supplier 2</th>
											<th class="txtCenter" width="350"> Supplier 3</th>
                                            @endif
                                            <th class="txtCenter" width="350">Quotation No</th>
                                            <th class="txtCenter" width="350">Date Quotation</th>
                                            <th class="txtCenter" width="100">Quantity</th>
                                            @if(Auth::user()->user_grp == 'supp')
                                            <th class="txtCenter" width="100">Status</th>
                                            @endif
...
<script>
    ...
    $(function() {
        ...
        $('#btnCari').on('click', function() {
            ...
            table.ajax.url( vUrl+'?date='+year+'-'+month ).load();
      ...
      var  table = $('.data-table').DataTable({
            ...
            columns: [
                ...
                {data: 'tanggal_format', name: 'TANGGAL', "className": "text-center",},
                ...
                {   
                    ...
                    render: function(data,row, full){
                        return `<a href="{{route('qtawal')}}/`+full.DOCNO+`" class="btn btn-sm btn-primary"><i class="fa fa-search"></i> Detail</a>`;
                    },
                    "orderable": false,
                    "searchable": false
                }

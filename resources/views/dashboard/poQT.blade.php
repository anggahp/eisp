                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb" role="navigation" class="pull-left">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">PO Quotation</li>
                        </ol>
                    </nav>
                        ...
                        <div class="panel panel-default" style="border-color: #ddd;">
                            <div id="listItems" class="panel-body">
                                ...
                                <table class="table table-hover table-responsive table-bordered mb-0 data-table">
                                    <thead>
                                        <tr>
                                            <th class="txtCenter" width="20">No Quotation</th>
                                            <th class="txtCenter" width="80">Supplier</th>
                                            <th class="" width="100">Nomor PP</th>
                                            <th class="" width="100">Keterangan Barang</th>
                                            <th class="" width="100">QTY</th>
                                            <th class="" width="100">Harga</th>
                                            <th class="txtCenter" width="100">Tanggal Dokumen</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/poqt') }}" method="POST" class="form-body" role="form" autocomplete="off" id="frmUploadKanban">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="DOCNO">Nomor Quotation</label>
                                    <input type="text" class="form-control" id="OCNO" name="DOCNO" placeholder="DOCNO"  onkeyup="this.value = this.value.toUpperCase();" readonly style="background-color: transparent;">
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    if (vtampDate != '') {
        vUrl = '{{ route('poqt') }}'+'/'+vtampDate+'/date';
    }
    $(function() {
        $.ajaxSetup({
            headers: {
...
<script>
    ...
    $('#btnCari').on('click', function() {
        ...
        window.location.href="{{ route('poqt') }}"+"/"+strDate+"/date";
    });
